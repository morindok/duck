...
فایل اصلی: [`pythonProject/.idea/pythonProject.iml`](pythonProject/.idea/pythonProject.iml)

## 📖 معرفی
**pythonProject** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
