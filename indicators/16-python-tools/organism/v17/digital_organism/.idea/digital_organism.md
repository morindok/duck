...
فایل اصلی: [`organism/v17/digital_organism/.idea/digital_organism.iml`](organism/v17/digital_organism/.idea/digital_organism.iml)

## 📖 معرفی
**digital_organism** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
