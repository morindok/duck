...
فایل اصلی: [`organism/v17/digital_organism/.idea/untitled.gitignore`](organism/v17/digital_organism/.idea/untitled.gitignore)

## 📖 معرفی
**untitled** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
