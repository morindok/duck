...
فایل اصلی: [`organism/v17/digital_organism/.idea/workspace.xml`](organism/v17/digital_organism/.idea/workspace.xml)

## 📖 معرفی
**workspace** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
