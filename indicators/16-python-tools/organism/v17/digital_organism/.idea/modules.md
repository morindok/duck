...
فایل اصلی: [`organism/v17/digital_organism/.idea/modules.xml`](organism/v17/digital_organism/.idea/modules.xml)

## 📖 معرفی
**modules** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
