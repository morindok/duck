...
فایل اصلی: [`organism/v17/digital_organism/.idea/inspectionProfiles/profiles_settings.xml`](organism/v17/digital_organism/.idea/inspectionProfiles/profiles_settings.xml)

## 📖 معرفی
**profiles_settings** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
