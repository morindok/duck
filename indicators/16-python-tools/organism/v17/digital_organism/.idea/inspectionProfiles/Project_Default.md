...
فایل اصلی: [`organism/v17/digital_organism/.idea/inspectionProfiles/Project_Default.xml`](organism/v17/digital_organism/.idea/inspectionProfiles/Project_Default.xml)

## 📖 معرفی
**Project_Default** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
