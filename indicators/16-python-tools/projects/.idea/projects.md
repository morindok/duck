...
فایل اصلی: [`projects/.idea/projects.iml`](projects/.idea/projects.iml)

## 📖 معرفی
**projects** یکی از اندیکاتورهای دسته «Python Tools» است. ابزارهای پایتون — کلاک، اسپیرال، فوت‌پرینت، گن، شبکه عصبی
